...
Route::get('/', function () {
    ...
    $data = ['lunghe' => $lunghe, 'corte' => $corte, 'cortissime' => $cortissime, 'nomePagina' => 'La Molisana - Home'];
...
Route::get('products/{id}', function ($id) {
    ...
    return view('guest.product', ['product' => $singleProduct, 'nomePagina' => $singleProduct['titolo']]);
})->name('product');
